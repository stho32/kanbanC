...
| F0022 | Feature | I0012 | Einfügelinie statt Ablagekästen | rot | Die Ablageorte erscheinen als 2-px-Linie an der Zielstelle statt als beschriftete Kästen; Drop-Ziel ist die überfahrene Karte (obere Hälfte davor, untere dahinter), die Restfläche unter der letzten Karte und die leere Bahn nehmen ganzflächig an | | | 2 | F0019 | R00008 | Ausbaustufe 2; vom Menschen beauftragt, Artboard D0003 am 2026-09-03 nachgezogen |
| B0103 | Bubble | F0022 | Ziellage aus Karte und Hälfte | rot | Test gruen | gezogene Karte + überfahrene Karte + Haelfte → Ablagestellen.Zielposition → Kartenlage | 0,4 | | | | Operation, pure Logik; loest die n+1-Stellenrechnung ab, die Korrektur bei gleicher Bahn bleibt; Aufwand belegt (B0093) |
| B0104 | Bubble | F0022 | Karte nimmt an | rot | Test gruen | Karte.razor → obere und untere Haelfte als Ablagezonen mit ondragover/ondrop → gemeldete Ziellage | 2 | | | | UI; zwei Zonen statt Mausgeometrie — spart JS-Interop |
| B0105 | Bubble | F0022 | Einfügelinie zeigen | rot | Test gruen | überfahrene Haelfte → Spaltenbahnen.razor(.css) → 2-px-Linie an der Zielstelle; Kaesten und Beschriftung entfallen | 2 | | | | UI; Werte aus dem Artboard, --color-accent |
| B0106 | Bubble | F0022 | Restfläche und leere Bahn nehmen an | rot | Test gruen | Zug über der Flaeche unter der letzten Karte oder über einer leeren Bahn → Spaltenbahnen.razor → Karte ans Ende | 2 | | | | UI |
