...
| F0022 | Feature | I0012 | Einfügelinie statt Ablagekästen | gelb | Die Ablageorte erscheinen als 2-px-Linie an der Zielstelle statt als beschriftete Kästen; Drop-Ziel ist die überfahrene Karte (obere Hälfte davor, untere dahinter), die Restfläche unter der letzten Karte und die leere Bahn nehmen ganzflächig an | | | 2 | F0019 | R00008 | Ausbaustufe 2; vom Menschen beauftragt, Artboard D0003 am 2026-09-03 nachgezogen |
...
| B0104 | Bubble | F0022 | Karte nimmt an | gelb | Test gruen | Karte.razor → obere und untere Haelfte als Ablagezonen mit ondragover/ondrop → gemeldete Ziellage | 2 | | | | UI; zwei Zonen statt Mausgeometrie — spart JS-Interop |
| B0105 | Bubble | F0022 | Einfügelinie zeigen | gelb | Test gruen | überfahrene Haelfte → Spaltenbahnen.razor(.css) → 2-px-Linie an der Zielstelle; Kaesten und Beschriftung entfallen | 2 | | | | UI; Werte aus dem Artboard, --color-accent |
| B0106 | Bubble | F0022 | Restfläche und leere Bahn nehmen an | gelb | Test gruen | Zug über der Flaeche unter der letzten Karte oder über einer leeren Bahn → Spaltenbahnen.razor → Karte ans Ende | 2 | | | | UI |
| B0107 | Bubble | F0022 | E2E Einfügelinie und Ablagefläche | rot | Test gruen | Playwright → Linie erscheint, Karte landet vor/hinter der Zielkarte, Restflaeche haengt an, leere Bahn nimmt an | 2-4 | | | | E2E; unklar: BoardSeite.AblagestelleDerBahn entfaellt, sechs Tests aus F0019 ziehen nach |
