...
{
    // Der Umschalter führt fünf Auswertungen, und seit dem Puffer-Verbrauch sind alle fünf Wege.
    [Test]
    [Category("US-1")]
    public async Task Wenn_der_Schirm_offen_ist_dann_ist_Burndown_waehlbar_und_kein_Punkt_mehr_gesperrt()
    {
