...
public class ArchivfilterTests
{
    ...
    {
        var ergebnis = Archivfilter.Aus(null);
    ...
    {
        var ergebnis = Archivfilter.Aus("true");
    ...
    {
        var mitFalse = Archivfilter.Aus("false");
        var ohneParameter = Archivfilter.Aus(null);
    ...
    {
        var ergebnis = Archivfilter.Aus("vielleicht");
    ...
    {
        var ergebnis = Archivfilter.Aus("1");
