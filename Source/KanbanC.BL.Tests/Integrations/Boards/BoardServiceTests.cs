...
public class BoardServiceTests
{
    ...
    public void Wenn_die_Abschlussbahn_ueber_ihrer_Grenze_liegt_dann_kuerzt_der_Dienst_sie_am_Ausgang()
    {
        ...
        var abschlussbahn = new Spalte(9, "Erledigt", 1, true, 2, [
            new Karte(1, "Vorgestern", 1, new DateOnly(2026, 9, 3), Beschreibung: null, FaelligAm: null, Farbe: Kartenfarbe.Ohne, Kontributor: null, Kartennummer: null),
            new Karte(2, "Heute", 2, new DateOnly(2026, 9, 5), Beschreibung: null, FaelligAm: null, Farbe: Kartenfarbe.Ohne, Kontributor: null, Kartennummer: null),
            new Karte(3, "Gestern", 3, new DateOnly(2026, 9, 4), Beschreibung: null, FaelligAm: null, Farbe: Kartenfarbe.Ohne, Kontributor: null, Kartennummer: null),
        ], Kartenzahl: 3);
