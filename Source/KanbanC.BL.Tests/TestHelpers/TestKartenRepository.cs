...
public sealed class TestKartenRepository : IKartenRepository
{
    ...
    public Karte? LegeAn(long boardId, long spalteId, KarteAnlegenAnfrage anfrage)
    {
        ...
        var karte = new Karte(_naechsteKarteId, Kartentitel.Normalisiert(anfrage.Titel), karten.Count + 1, ErledigtAm: null, Beschreibung: null, FaelligAm: null, Farbe: Kartenfarbe.Ohne, Kontributor: null, Kartennummer: null);
