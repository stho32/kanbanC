...
public class BahnenkopfzahlTests
{
    ...
    {
        return Enumerable.Range(1, anzahl).Select(nummer => new Karte(nummer, $"K{nummer}", nummer, ErledigtAm: null, Beschreibung: null, FaelligAm: null, Farbe: Kartenfarbe.Ohne, Kontributor: null, Kartennummer: null)).ToList();
    }
}
